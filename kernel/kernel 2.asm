...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  while(n > 0){
    ...
    800001c0:	180080e7          	jalr	384(ra) # 8000233c <killed>
...
killed(struct proc *p)
{
  ...
  return k;
    ...
    80002368:	6902                	ld	s2,0(sp)
    8000236a:	6105                	add	sp,sp,32
    8000236c:	8082                	ret

000000008000236e <wait>:
{
    8000236e:	715d                	add	sp,sp,-80
    ...
    80002384:	0880                	add	s0,sp,80
    80002386:	8b2a                	mv	s6,a0
  struct proc *p = myproc();
    80002388:	fffff097          	auipc	ra,0xfffff
    8000238c:	61e080e7          	jalr	1566(ra) # 800019a6 <myproc>
    80002390:	892a                	mv	s2,a0
  acquire(&wait_lock);
    80002392:	0000e517          	auipc	a0,0xe
    80002396:	7c650513          	add	a0,a0,1990 # 80010b58 <wait_lock>
    8000239a:	fffff097          	auipc	ra,0xfffff
    8000239e:	838080e7          	jalr	-1992(ra) # 80000bd2 <acquire>
    havekids = 0;
    800023a2:	4b81                	li	s7,0
        if(pp->state == ZOMBIE){
    800023a4:	4a15                	li	s4,5
        havekids = 1;
    800023a6:	4a85                	li	s5,1
    for(pp = proc; pp < &proc[NPROC]; pp++){
    800023a8:	00014997          	auipc	s3,0x14
    800023ac:	5c898993          	add	s3,s3,1480 # 80016970 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    800023b0:	0000ec17          	auipc	s8,0xe
    800023b4:	7a8c0c13          	add	s8,s8,1960 # 80010b58 <wait_lock>
    800023b8:	a0d1                	j	8000247c <wait+0x10e>
          pid = pp->pid;
    800023ba:	0304a983          	lw	s3,48(s1)
          if(addr != 0 && copyout(p->pagetable, addr, (char *)&pp->xstate,
    800023be:	000b0e63          	beqz	s6,800023da <wait+0x6c>
    800023c2:	4691                	li	a3,4
    800023c4:	02c48613          	add	a2,s1,44
    800023c8:	85da                	mv	a1,s6
    800023ca:	05093503          	ld	a0,80(s2)
    800023ce:	fffff097          	auipc	ra,0xfffff
    800023d2:	298080e7          	jalr	664(ra) # 80001666 <copyout>
    800023d6:	04054163          	bltz	a0,80002418 <wait+0xaa>
          freeproc(pp);
    800023da:	8526                	mv	a0,s1
    800023dc:	fffff097          	auipc	ra,0xfffff
    800023e0:	77c080e7          	jalr	1916(ra) # 80001b58 <freeproc>
          release(&pp->lock);
    800023e4:	8526                	mv	a0,s1
    800023e6:	fffff097          	auipc	ra,0xfffff
    800023ea:	8a0080e7          	jalr	-1888(ra) # 80000c86 <release>
          release(&wait_lock);
    800023ee:	0000e517          	auipc	a0,0xe
    800023f2:	76a50513          	add	a0,a0,1898 # 80010b58 <wait_lock>
    800023f6:	fffff097          	auipc	ra,0xfffff
    800023fa:	890080e7          	jalr	-1904(ra) # 80000c86 <release>
}
    ...
    80002414:	6161                	add	sp,sp,80
    80002416:	8082                	ret
            release(&pp->lock);
    80002418:	8526                	mv	a0,s1
    8000241a:	fffff097          	auipc	ra,0xfffff
    8000241e:	86c080e7          	jalr	-1940(ra) # 80000c86 <release>
            release(&wait_lock);
    80002422:	0000e517          	auipc	a0,0xe
    80002426:	73650513          	add	a0,a0,1846 # 80010b58 <wait_lock>
    8000242a:	fffff097          	auipc	ra,0xfffff
    8000242e:	85c080e7          	jalr	-1956(ra) # 80000c86 <release>
            return -1;
    80002432:	59fd                	li	s3,-1
    80002434:	b7e9                	j	800023fe <wait+0x90>
    for(pp = proc; pp < &proc[NPROC]; pp++){
    80002436:	16848493          	add	s1,s1,360
    8000243a:	03348463          	beq	s1,s3,80002462 <wait+0xf4>
      if(pp->parent == p){
    8000243e:	7c9c                	ld	a5,56(s1)
    80002440:	ff279be3          	bne	a5,s2,80002436 <wait+0xc8>
        acquire(&pp->lock);
    ...
    80002450:	f74785e3          	beq	a5,s4,800023ba <wait+0x4c>
        release(&pp->lock);
    ...
    80002460:	bfd9                	j	80002436 <wait+0xc8>
    if(!havekids || killed(p)){
    80002462:	c31d                	beqz	a4,80002488 <wait+0x11a>
    80002464:	854a                	mv	a0,s2
    80002466:	00000097          	auipc	ra,0x0
    8000246a:	ed6080e7          	jalr	-298(ra) # 8000233c <killed>
    8000246e:	ed09                	bnez	a0,80002488 <wait+0x11a>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    80002470:	85e2                	mv	a1,s8
    80002472:	854a                	mv	a0,s2
    80002474:	00000097          	auipc	ra,0x0
    80002478:	bda080e7          	jalr	-1062(ra) # 8000204e <sleep>
    havekids = 0;
    8000247c:	875e                	mv	a4,s7
    for(pp = proc; pp < &proc[NPROC]; pp++){
    8000247e:	0000f497          	auipc	s1,0xf
    80002482:	af248493          	add	s1,s1,-1294 # 80010f70 <proc>
    80002486:	bf65                	j	8000243e <wait+0xd0>
      release(&wait_lock);
    80002488:	0000e517          	auipc	a0,0xe
    8000248c:	6d050513          	add	a0,a0,1744 # 80010b58 <wait_lock>
...
0000000080002824 <usertrap>:
{
  ...
  if(killed(p))
    ...
    80002874:	acc080e7          	jalr	-1332(ra) # 8000233c <killed>
    ...
    80002890:	ab0080e7          	jalr	-1360(ra) # 8000233c <killed>
  ...
  if(killed(p))
    ...
    800028b8:	a88080e7          	jalr	-1400(ra) # 8000233c <killed>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002924:	9f0080e7          	jalr	-1552(ra) # 80002310 <setkilled>
...
sys_wait(void)
{
  ...
  return wait(p);
    ...
    80002c66:	70c080e7          	jalr	1804(ra) # 8000236e <wait>
}
...
sys_sleep(void)
{
  ...
  while(ticks - ticks0 < n){
    ...
    80002d0a:	636080e7          	jalr	1590(ra) # 8000233c <killed>
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  while(i < n){
    ...
    80004a02:	93e080e7          	jalr	-1730(ra) # 8000233c <killed>
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80004ab4:	88c080e7          	jalr	-1908(ra) # 8000233c <killed>
